        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold">RunPulse File Parser</h1>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          {!apiKey && (
            <Alert>
              ...
              <AlertDescription>
                This is a demo application. To process real documents, you'll need a RunPulse API key. 
      ...
      <footer className="border-t bg-white/80 backdrop-blur-sm mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-sm text-muted-foreground">
            <p>Built with RunPulse API • Powered by AI • Secure Document Processing</p>
          </div>
        </div>
      </footer>
    </div>
